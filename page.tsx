...
import per from "../../images/WhatsApp Image 2024-09-30 at 23.38.07_850e14a9.jpg"
...
export default function Home() {
  return (
    <div className="main">
      ...
      <div className="left">
        <img className="imgo" src={per.src} alt="" height={70} width={200} />
        <h1 className="ftext">
          Muhammad Owais
        </h1>
        <hr className="hr" />
        ...
        <ul className="links">
         <a href="https://github.com/OwaisImran2005"><img src={git.src} alt="pic1" height={55} width={65}/> </a> 
          <a href=""><img src={dic.src} alt="pic2" height={50} width={60}/></a>
